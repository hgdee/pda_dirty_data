...
candy_sum <- aggregate(pivot_candy$customer_satisfaction, 
           by=list(your_gender=pivot_candy$your_gender,
          candy_bar_name=pivot_candy$candy_bar_name), FUN=sum)  

rbind(
  candy_sum %>%
      arrange(desc(x), candy_bar_name, your_gender)  %>%
